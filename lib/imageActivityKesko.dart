import 'package:cgi_kesko/FoodPictureKesko.dart';
import 'package:cgi_kesko/IngredientCheckbox.dart';
import 'package:cgi_kesko/recipe.dart';
import 'package:cgi_kesko/recipeKesko.dart';
...
class ImageActivityKesko extends StatefulWidget {
  final RecipeKesko recipe;
  ImageActivityKesko({this.recipe});
  @override
  ImageActivityKeskoState createState() => ImageActivityKeskoState();
}

class ImageActivityKeskoState extends State<ImageActivityKesko> {
  int index;
                          ...
                          child: Column(
                            children: <Widget>[
                              Card(
                                child: Column(
                                  children: <Widget>[
                                    FoodPictureKesko(recipe: widget.recipe),
                                    Container(
                                      margin:
                                          ...
                                          Column(
                                            ...
                                            children: <Widget>[
                                              _recipeDetail(
                                                  ...
                                                  ' 5 minutes',
                                                  Icons.access_time),
                                              _recipeDetail('Serves:', '4',
                                                  Icons.fastfood),
                                              _recipeDetail('Difficulty: ',
                                                  'easy', Icons.filter_vintage),
                                              // _smallText(
